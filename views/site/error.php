...
/**
 * Generic error page, rendered by SiteController's 'error' action (registered via
 * config/web.php's errorHandler.errorAction) for any uncaught HttpException/error.
 *
