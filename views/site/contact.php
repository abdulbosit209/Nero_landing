...
/**
 * Unmodified Yii2 template contact page (generic Yii branding/copy), rendered by
 * SiteController::actionContact(). This is separate from the landing page's lead
 * form — that one lives at views/site/_lead-form.php and posts to actionSubmitLead().
 * Not linked from the landing page nav — replace with real content or remove the
 * action/route if it isn't needed.
 *
